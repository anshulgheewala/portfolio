...
function Imageblock() {
    ...
    return (    
       ...
       <div className={styles.buttondiv}>
        <button className='bg-transparent border-2 text-white p-4 rounded-lg font-semibold  hover:translate-x-0 hover:-translate-y-2 hover:ease-in-out duration-300 w-40' onClick={alert('Sorry Currently Unavailable!')}>Download CV</button>
